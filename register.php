...
<html lang="en">
  ...
  <section class="navbar">
    ...
    <div>   
    <h2 class="regis">Register form</h2>
    </div> 
  <div class="mb-3">
   Username:
    ...
    <div class="mb-3">
        Mobile:
      <input type="text" name="r_mobile" class="form-control" >
    </div>
    <div class="mb-3">
        Password:
    ...
    <div class="mb-3">
       Confirm Password:
      <input type="password" name="r_con_pass" class="form-control" >
    </div>
  
  <div class="mb-3">
  <button type="login" class="btn btn-info d-block m-auto col-12">Register Here</button> 
